...
(defn getmessage [playertotal dealertotal]
  (if(<= dealertotal 21)(if(> playertotal dealertotal)"you have won" "the dealer has won")  "you have won" )
   )
